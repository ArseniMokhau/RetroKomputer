...
namespace EmulatorBackend.Emulator
{
    public class mos6502
    {
        ...
        private const int MaxInstructions = 100;
        ...
        public void Reset()
        {
            ProgramCounter = (ushort)(Memory[0xFC] | (Memory[0xFD] << 8));
        ...
        private void StackPush(byte value)
        {
            ...
            Memory[0x50+ StackPointer] = value;
        }
        ...
        private byte PopFromStack()
        {
            ...
            return Memory[0x50 + StackPointer];
        }
